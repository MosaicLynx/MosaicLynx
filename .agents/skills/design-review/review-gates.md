...
6. セキュリティと相互運用性: protected asset、secret lifecycle、authorization / signing authority、failure safety、security invariant、Symbol / NEM、Mainnet / Testnet、Extension / SDK / Relay / 外部 wallet-core の境界を弱めていない。
