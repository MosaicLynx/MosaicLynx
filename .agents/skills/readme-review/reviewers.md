...
package manifest、workspace、公開exports、型、実装、サンプルとREADMEのpackage名、import、API、引数、戻り値、環境、versionを照合する。
...
未実装機能、将来機能、security注意、chain / network、署名 gate、Relay保証、license、移行情報、内部詳細の過剰記載を確認する。
