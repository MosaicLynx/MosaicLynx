...
export const deriveRelayKeys = async (
  ...
  const derive = (info: string): Promise<CryptoKey> =>
...
export const encryptJson = async (key: CryptoKey, value: unknown, aad: unknown): Promise<EncryptedRelayEnvelope> => {
...
export const decryptJson = async (key: CryptoKey, envelope: EncryptedRelayEnvelope, aad: unknown): Promise<unknown> => {
