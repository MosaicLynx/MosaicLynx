...
| MR-AC-012 | スクリーンショット、画面録画、最近使ったアプリ一覧、通知表示等による露出リスクが評価され、必要な platform policy が定められ、OS / platform が防止できない範囲の露出を完全に防止できる保証として利用者へ表示しない。                                                                                 |
...
| MR-005  | Concept §6.3、§11、§13；CR-010、CR-NFR-003、CR-NFR-009〜CR-NFR-011  | `docs/design/architecture.md`、`docs/specifications/web-transaction-handoff-spec.md`、`docs/mobile/mobile-support.md`         | Mobile lifecycle / pending request の後続仕様      | —                                                                                                                                                            | MR-AC-004                                      |
...
| MR-007  | Concept §9、§13；CR-008、CR-013、CR-NFR-004                         | `docs/design/architecture.md`、`docs/specifications/profile-account-spec.md`                                                  | wallet-core 統合・platform integration の後続設計  | `_snwc/README.md`、`_snwc/docs/requirements/requirements.md`、`_snwc/docs/specifications/specification.md`、`_snwc/docs/decisions/binding-implementation.md` | MR-AC-005、MR-AC-010                           |
...
| MR-012  | Concept §6.4、§9、§13；CR-006、CR-011                               | `docs/requirements/relay.md`、`docs/design/architecture.md`                                                                   | Relay / Mobile handoff の後続仕様                  | —                                                                                                                                                            | MR-AC-002、MR-AC-003、MR-AC-005、MR-AC-013     |
...
| MR-OPEN-003 | Concept §9、§13；CR-013、CR-OPEN-001、CR-OPEN-002    | `docs/design/architecture.md`、`docs/specifications/profile-account-spec.md`         | platform integration・Binding・OS 保護境界の後続設計        | `_snwc/README.md`、`_snwc/docs/requirements/requirements.md`、`_snwc/docs/specifications/specification.md`、`_snwc/docs/decisions/binding-implementation.md` |
...
| MR-OPEN-005 | Concept §6.3、§11；CR-NFR-009〜CR-NFR-011            | `docs/design/architecture.md`、`docs/specifications/web-transaction-handoff-spec.md` | lifecycle・pending request の後続仕様                       | —                                                                                                                                                            |
