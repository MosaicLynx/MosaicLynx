...
| BR-010 | Concept Sheet 13；Chrome の権限モデルと security guidance                                                                           | Concept Sheet の安全境界と Chrome の権限モデル / security guidance を補助根拠とし、署名要求の受付・確認に必要な範囲へ限定する MUST を本要件定義で正式採用する。具体的な permission の必須性・一覧は下流。                                                                                                             |
