...
| Validation                                                                                    | 結果                                                                                                                                                                                                                                          |
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Target Markdown formatter                                                                     | `mise exec -- pnpm exec prettier --check docs/specifications/browser-extension.md` を実行し、成功。直接の `pnpm exec` は pnpm database error となったため、mise 経由で検証した。                                                              |
| Review artifact formatter                                                                     | 作成後に `mise exec -- pnpm exec prettier --write docs/reviews/specifications/browser-extension-review-003.md`、続けて `mise exec -- pnpm exec prettier --check docs/reviews/specifications/browser-extension-review-003.md` を実行し、成功。 |
