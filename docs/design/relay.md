...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| SDK               | Web Application integration、transport / provider orchestration、request / response correlation、handoff context の受け渡しおよび安全側の結果分類                                                                                                                 | Authentication、Signing-capable unlock、Account authorization、Explicit user approval、semantic inspection、signing、secret handling、Signer の最終 caller / source authority                          |
