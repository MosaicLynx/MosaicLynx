...
Application Profile は作成時に一つの Chain と一つの Network に固定する。Symbol と NEM の両方を利用する場合は Chain ごとに別 Profile を管理し、同一 Profile に異なる Chain の Account、permission、default Account または signing authorization を登録しない。

- 外部へ公開する Account は public identity に限定する。
- Account の Chain が Profile の固定 Chain と一致しない場合は、Account、permission または authorization を成立させない。
...
| Profile / Account authority と Account authorization                  | [共通要件](../requirements/requirements.md) CR-005、CR-009、CR-013、CR-016、CR-017、CR-AC-020；[Browser Extension 要件](../requirements/browser-extension.md) BR-004、BR-009；[Architecture](./architecture.md) §6.6、§6.8–§6.9；[Interfaces](./interfaces.md) §6                               | [Profile / Account Specification](../specifications/profile-account-spec.md) §2、§3、§11、§12、§20、§26；[Browser Extension Specification](../specifications/browser-extension.md) §9–§10、§25；wallet-core は cryptographic identity / Store owner であり、Application Account authorization owner ではない                                                                                                                            | §5.4、§7–§10、§15、§20–§21           |
